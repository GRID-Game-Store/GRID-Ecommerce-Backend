...
ELSE
				...
				INSERT INTO games (title, description, release_date, system_requirements, price, discount, permit_age, cover_image_url, developer_id, publisher_id)
				VALUES (game_title, game_description, game_release_date, game_system_requirements, game_price, game_discount, game_permitted_age , game_cover_image_url, dev_id, publish_id);
